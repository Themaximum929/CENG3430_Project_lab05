...
HD_PWD='C:/Users/Mashiro/lab05/lab05.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_driver.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_driver.tcl
