...
HD_PWD='C:/Users/Mashiro/lab05/lab05.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_driver.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga_driver.tcl -notrace
